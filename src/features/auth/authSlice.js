...
export const activate = createAsyncThunk(`auth/activate`, async (formdata) => {
...
export const forgotPassword = createAsyncThunk(
  ...
  async (emailDto) => {
    const response = await AuthApi.forgotPassword(emailDto);
    return response.data;
  }
);
...
export const selectUserEventId = (store) => store.auth.sesh.event;
export const selectSesh = (store) => store.auth.sesh;
